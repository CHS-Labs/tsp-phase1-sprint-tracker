        ...
        <div className="flex items-center gap-4 ml-6">
          ...
          <div className="flex items-center gap-3 pl-4 border-l border-gray-300">
            <div className="text-right">
              ...
              <p className="text-xs text-gray-500">Lead Architect</p>
            </div>
            <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#E98A24] to-[#1A9CD7] flex items-center justify-center">
